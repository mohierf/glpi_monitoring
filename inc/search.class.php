            ...
            for ($i = 0; $i < $_SESSION["glpisearchcount"][$itemtype]; $i++) {
                ...
                if ($i == 0) {
                   ...
                   document.forms['searchform$itemtype'].submit();\">";
                    echo "<img alt=\"+\" src=\"" . $CFG_GLPI["root_doc"] . "/pics/plus.png\" title=\"" .
                    ...
                    if ($_SESSION["glpisearchcount"][$itemtype] > 1) {
                      ...
                      document.forms['searchform$itemtype'].submit();\">";
                        echo "<img alt=\"-\" src=\"" . $CFG_GLPI["root_doc"] . "/pics/moins.png\" title=\"" .
                    ...
                    if (is_array($linked) && count($linked) > 0) {
                      ...
                      document.forms['searchform$itemtype'].submit();\">";
                        echo "<img alt=\"+\" src=\"" . $CFG_GLPI["root_doc"] . "/pics/meta_plus.png\" title=\"" .
                        ...
                        if ($_SESSION["glpisearchcount2"][$itemtype] > 0) {
                         ...
                         document.forms['searchform$itemtype'].submit();\">";
                            echo "<img alt=\"-\" src=\"" . $CFG_GLPI["root_doc"] . "/pics/meta_moins.png\" title=\"" .
