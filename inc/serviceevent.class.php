...
//                return true;
    ...
    function getData($result, $perfdatas_id, $start_date, $end_date, $ret = [], $timecomplete = 0, $todisplay = [])
    {
        global $DB;
...
//         }
        ...
        return [$mydatat, $a_labels, $a_ref, $a_convert, $a_perfdata_name];
    }
