...
Html::header(__("Monitoring - configuration page", 'monitoring'), $_SERVER['PHP_SELF'], "config", "plugins");
echo __("This is the plugin configuration page", 'monitoring');
echo ("<br>");
...
try {
   ...
   PluginMonitoringToolbox::log("Loading template: " . $filename);
