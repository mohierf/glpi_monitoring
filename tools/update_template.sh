...
# Create the pot file
xgettext *.php ajax/*.php front/*.php inc/*.php -o locales/monitoring.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po \
...
msgmerge --update locales/en_GB.po locales/monitoring.pot
